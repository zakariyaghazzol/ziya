function record({ canonicalName, aliases = [], category, function: ingredientFunction, plainDescription, whyUsed, nutritionRole, tags = [], dietFlags, allergenSources = [] }) {
  return Object.freeze({
    ...
    allergenSources: [...new Set(allergenSources)]
  });
}
...
export const VAGUE_INGREDIENT_TERMS = Object.freeze([
  ...
  record({ canonicalName: "emulsifiers", aliases: ["emulsifier", "emulsifiant", "emulsifiants", "emulsifying agents"], category: "broad additive function term", function: "emulsification", plainDescription: "A broad label term for ingredients that help oil- and water-based components mix. The exact emulsifiers may be listed elsewhere on the label.", whyUsed: "Stabilizes mixing and texture.", nutritionRole: "Usually not a major nutrient contributor at typical formulation levels.", tags: ["emulsifier", "texture"] }),
  record({ canonicalName: "lecithins", aliases: ["lecithin", "lecithins"], category: "emulsifier", function: "emulsification", plainDescription: "A lecithin emulsifier term whose plant or animal source is not identified in this phrase.", whyUsed: "Helps oil- and water-based ingredients mix and remain stable.", nutritionRole: "Usually not a major nutrient contributor at typical formulation levels.", tags: ["emulsifier"] }),
  record({ canonicalName: "tree nuts", aliases: ["nuts"], category: "broad nut term", function: "food ingredient", plainDescription: "A broad nut term that does not identify the exact nut source.", whyUsed: "Adds flavor, texture, protein, or fat.", nutritionRole: "Nutrient contribution depends on the specific nut and amount used.", tags: ["nut", "tree-nut-source"], allergenSources: ["tree nuts"] }),
